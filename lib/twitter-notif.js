...
module.exports = function(hexo) {
    ...
    var twitter = new Twit(hexo.config.twitter);
...
function closePlugin() {
    console.log("[TwitterNotif] Closing the Twitter notification plugin.");
}
    ...
    return new Promise(function(resolve, reject) {
        T.post('statuses/update', { status: content }, function(err, data, response) {
            if (err) {
                ...
                throw new Error("[TwitterNotif] Could not update the status " + error);
                reject(err);
            } else {
